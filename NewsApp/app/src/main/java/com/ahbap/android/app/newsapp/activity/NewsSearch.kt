...
const val _SEARCH_API = "901f543bdc0346979e49d5fe8efb7fd1"

@Composable
fun NewsSearch(nav: NavHostController, str: String) {
    var list by remember {
        mutableStateOf(emptyList<Article>())
    }

    list = NewsCity(str, LocalDate.now().minusDays(2).toString(),_SEARCH_API)
